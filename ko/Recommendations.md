...
- 소속: [비바리퍼블리카](https://toss.im/)
- 함께한 일: 피알앤디컴퍼니에서 함께 근무함
- 추천사

제 인생 최고의 롤모델 입니다.

1. 입사하기 전부터 롤모델이었고 도메인에 전혀 관심이 없었지만 같이 일 하고 싶어서 회사에 입사 했습니다.
2. 팀장 그리고 리더로써 저의 부족한 부분에 대해 피드백을 확실하게 해주었고 도움이 필요한 부분은 서포트 해주셔서 같이 일 하면서 성장 할 수 있었습니다.
3. 끊임없이 성장하기 위해 노력하는 모습을 보고 저 또한 자극이 되어서 지금의 제가 될 수 있었습니다.
4. 나중에 기회가 되면 꼭 다시 일 하고 싶은 개발자 1순위 입니다.
